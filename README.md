...
<p>File repository for the optimized version of Married Bob web comic  for Bulletin Board System (BBS) in .ANS file format. The file repository is updated weekly (sometimes more frequently than that) with new comics.</p>
